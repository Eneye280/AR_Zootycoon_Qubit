...
public class InstanceManager : MonoBehaviour
{
    ...
    private void Start()
    {
        for (int i = 0; i < managerAnimals.prefabAnimals.Length; i++)
        {
    ...
    {
        referencePrefabInstance = Instantiate(managerAnimals.prefabAnimals[index]/*, hitPose.position, hitPose.rotation*/);
        referencePrefabInstance.transform.parent = managerAnimals.positionParentInstance;
