...
public class InstanceManager : MonoBehaviour
{
    ...
    public void Update()
    {
        if (isEnableInstance)
        {
            ...
            if (m_RaycastManager.Raycast(touchPosition, s_Hits, TrackableType.PlaneWithinPolygon))
            {
                ...
                GetComponent<ARPlaneManager>().planePrefab.GetComponent<GameObject>().SetActive(false);
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<MeshRenderer>().enabled = false;
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARPlane>().enabled = false;
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARPlaneMeshVisualizer>().enabled = false;
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARFeatheredPlaneMeshVisualizer>().enabled = false;
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<FadePlaneOnBoundaryChange>().enabled = false;
                //GetComponent<ARPlaneManager>().planePrefab.GetComponent<Animator>().enabled = false;
            }
        }
    }
    ...
    public void CallInformativeToInstance(int index)
    {
        ...
        foreach (var item in managerSpecie.buttonContentAnimals)
        {
            managerSpecie.verifyPositionList = indexSpawnAnimals;
        }
        ...
        GetComponent<ARPlaneManager>().planePrefab.GetComponent<GameObject>().SetActive(true);
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<MeshRenderer>().enabled = true;
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARPlane>().enabled = true;
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARPlaneMeshVisualizer>().enabled = true;
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<ARFeatheredPlaneMeshVisualizer>().enabled = true;
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<FadePlaneOnBoundaryChange>().enabled = true;
        //GetComponent<ARPlaneManager>().planePrefab.GetComponent<Animator>().enabled = true;
